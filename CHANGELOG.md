...
- Use gh token env for homebrew auth
- Set node auth token
- *(release)* Prepare release version v0.3.22
...
- Use unique branch name for homebrew tap pr
- Fix npm publishing
- *(release)* Prepare release version v0.3.20
...
- Fix tag check
- *(release)* Prepare release version v0.3.18

## [0.3.17] - 2025-12-30

### ⚙️ Miscellaneous Tasks

- Fix tag check for docker build
- *(release)* Prepare release version v0.3.17
...
- *(release)* Prepare release version v0.3.15
